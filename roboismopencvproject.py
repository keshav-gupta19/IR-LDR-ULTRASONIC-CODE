    ...
    for contour in contours:
        ...
        if len(approx) == 4:
            ...
            if asp_rat >= 0.98 and asp_rat <= 1.02:  # Detecting The Squares
                ...
                # cv2.putText(resizedimg,color,(x,y),cv2.FONT_HERSHEY_COMPLEX,0.5,(25,25,0),1)
                return box, x1, y1
